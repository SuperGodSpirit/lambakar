      ...
      <nav className="fixed w-full z-50 top-0 bg-white/80 backdrop-blur-md border-b border-slate-200/50">
        <div className="flex justify-between items-center p-4 md:px-10 max-w-7xl mx-auto">
          ...
          <div className="flex gap-4 items-center">
            <a href="https://www.instagram.com/amnx.fit" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-indigo-600 transition-colors">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 md:p-10 rounded-[2.5rem] shadow-2xl relative">
            ...
            {!isDiscountApplied && (
              <div className="mb-6">
                ...
                {couponError && <p className="text-red-400 text-sm mt-2 flex items-center gap-1"><Info className="w-4 h-4"/>{couponError}</p>}
              </div>
            )}
            ...
            <button className="w-full bg-indigo-600 text-white py-5 rounded-2xl font-black text-lg hover:bg-indigo-500 transition-all shadow-lg hover:shadow-indigo-500/50 active:scale-95">
              Coming Soon!!
            </button>
